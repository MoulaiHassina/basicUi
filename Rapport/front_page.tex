...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\textsc{\Large Traitement Automatique du Langage Naturel}\\[0.5cm] % Major heading such as course name
	...
	\begin{minipage}{0.4\textwidth}
		\begin{flushleft}
			...
			MEDJKOUNE \textsc{Sofiane}\\ % Your name
	...
	\begin{minipage}{0.4\textwidth}
		\begin{flushright}
			\large
			\textit{Professeur}\\
			Mr. GUESSOUM Ahmed  % Supervisor's name
		\end{flushright}
	\end{minipage}
